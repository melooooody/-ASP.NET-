    ...
    <form id="form1" runat="server">
        <div style="height:100%;width:100%;position:absolute;">
            ...
            <div id="manage">
                ...
                <asp:Button ID="btnCheck" runat="server" Text="签收" OnClick="btnCheck_Click" />

                <asp:GridView ID="Gv1" Width="100%" runat="server" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GridView1_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ShopId" HeaderText="商品店家" />
